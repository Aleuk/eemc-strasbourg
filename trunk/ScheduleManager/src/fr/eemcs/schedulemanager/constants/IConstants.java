...
public interface IConstants {
	...
	public final static String CATEGORIE_MESSAGES = "Historique";
	public final static String CATEGORIE_MUSIQUE = "Musique";
	public final static String CATEGORIE_VIDEOS = "Vidéos";
